...
type User struct {
	...
	Apartment  string    `boil:"apartment" json:"apartment" toml:"apartment" yaml:"apartment"`
	RoomNumber int       `boil:"room_number" json:"room_number" toml:"room_number" yaml:"room_number"`
...
var UserWhere = struct {
	...
	Apartment  whereHelperstring
	RoomNumber whereHelperint
	...
	Apartment:  whereHelperstring{field: "`user`.`apartment`"},
	RoomNumber: whereHelperint{field: "`user`.`room_number`"},
	CreateTime: whereHelpernull_Time{field: "`user`.`create_time`"},
}
...
var (
	userAllColumns            = []string{"id", "username", "email", "password", "apartment", "room_number", "create_time"}
	userColumnsWithoutDefault = []string{"username", "email", "password", "apartment", "room_number"}
	userColumnsWithDefault    = []string{"id", "create_time"}
...
func (userL) LoadHistories(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
...
func (o *User) AddHistories(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*History) error {
	var err error
