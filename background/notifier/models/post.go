...
type Post struct {
	...
	Room       int       `boil:"room" json:"room" toml:"room" yaml:"room"`
...
var PostWhere = struct {
	...
	Apartment:  whereHelperstring{field: "`post`.`apartment`"},
	Room:       whereHelperint{field: "`post`.`room`"},
...
var (
	postAllColumns            = []string{"id", "apartment", "room", "state", "create_time", "update_time"}
	postColumnsWithoutDefault = []string{"apartment", "room", "update_time"}
