...
import 'package:postapp/routes/home.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: Scaffold(
        appBar: AppBar(title: const Text('Postifyにようこそ')),
        body: Center(
          child: Form(
              key: _formKey,
              child: ListView(
      ...
      //   '/LoginP': (BuildContext context) => LoginScreen(),
      //   '/RegisterP': (BuildContext context) => RegisterPage(),
      // }
    );
  }
}

Future<void> signin(String loginemail, String loginpass) async {
